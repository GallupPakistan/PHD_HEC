...
def level_stacked_bar_chart(level_agg):
    ...
    fig.update_layout(**base_layout("Enrolment by Qualification Level", height=380))
    fig.update_layout(
        barmode="stack",
        xaxis_title="Year",
        yaxis_title="Enrolment",
...
def discipline_bar_chart_overview(disc_df):
    ...
    fig.update_layout(**base_layout("Enrolment by Discipline (Top 8)", height=380))
    fig.update_layout(
        showlegend=False,
...
def faculty_province_bar_chart(prov_agg):
    ...
    fig.update_layout(**base_layout("Faculty by Province (PhD vs Non-PhD)", height=380))
    fig.update_layout(
        barmode="group",
        xaxis_title="",
